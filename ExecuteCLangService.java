...
import com.ssmc.utils.CLangUtils;
...
public class ExecuteCLangService {
    private static final Logger log = LoggerFactory.getLogger(ExecuteCLangService.class);
    ...
    //代码存放路径
    public static final String CODE_PATH = "C:/Users/Mi/Desktop/codesegment/";
    ...
    public String getRunResult(final String sourceCode){
        System.out.println("test1:"+sourceCode);
